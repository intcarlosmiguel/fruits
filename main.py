...
acc_neural,neural_prev = Classfier(neural,X,Y,x,y,labels,'neural.png')
print('=======================================================\n')
print('Algoritmo de Regressão Logística')
acc_logistic, logistic_prev = Classfier(logistic,X,Y,x,y,labels,'Logistic.png')
print('=======================================================\n')
print('Algoritmo de Floresta Aleatória')
acc_forest, forest_prev = Classfier(forest,X,Y,x,y,labels,'Randomforest.png')
print('=======================================================\n')
print('Algoritmo de SVM')
acc_SVM, SVM_prev = Classfier(SVM,X,Y,x,y,labels,'SVM.png')
print('=======================================================\n')
print('Algoritmo de k-vizinhos mais próximos')
acc_neigh,neigh_prev = Classfier(neigh,X,Y,x,y,labels,'neighbors.png')
print('=======================================================\n')

#Junção de Algoritmos
prev = doubleClasfier(neural_prev,neigh_prev,acc_neural,acc_neigh)
print('Combinação de Algoritmos:')
CM(y,prev,labels,'twoalgorithms.png')

# Rede Neural do Pytorch
troch_acc , torch_prev = TorchNN(R_treino,R_teste,500,labels,'NNtorch.png')

prev = doubleClasfier(labels[torch_prev],neigh_prev,troch_acc,acc_neigh)
CM(y,prev,labels,'twoalgorithms2.png')